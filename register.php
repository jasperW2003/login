...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($loginSystem->addUser($email, $password)) {
        // Redirect to the login page after successful registration
        header('Location: index.php');
        exit();
    } else {
        $errorMsg = 'there already exist a user with this email';
    }
}
?>
<body>
        ...
        <div class="col-12 col-md-10 col-lg-6 col-xl-7 ">
          ...
          <div class="card-body  pb-5 pl-5 pr-5 Imb-4">
            <div class="text-center mb-5 pb-1">
                <img src="./img/mario.png" class="login-logo">
                        ...
                        <?php if (!empty($errorMsg)) { ?>
                            <p class="error-msg text-danger validationerrors"><?php echo $errorMsg; ?></p>
                        <?php } ?>
            ...
            <div class="form-outline pb-5 Imb-4">
              <label class="form-label text-light login-input-label" for="password"><b>Repeat Password</b></label>
              <input type="passwordRepeat" id="passwordRepeat" name="passwordRepeat" class="form-control corners form-control-lg" />
              <div id="passwordRepeatError" class="error text-danger"></div> <!-- Error message placeholder -->
            </div>
            <div  class="mt-5 pb-5">
            <button class="btn btn-light login-btn float-right corners " type="submit"><b>Submit</b></button>
...
<script>
       function validateForm() {
            ...
            const passwordRepeaValid = validateRepeatPassword();
